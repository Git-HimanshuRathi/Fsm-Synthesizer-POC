...
export function setup() {
    ...
    setTimeout(() => {
        if (__logix_project_id != 0) {
            // eslint-disable-line eqeqeq, camelcase
            $(".loadingIcon").fadeIn();
            $.ajax({
            ...
            showMessage(
                "We have detected an unexpected simulator crash. Don't worry we have recovered your project. Access them using Project->Recover",
            );
        }
    }, 1000);
